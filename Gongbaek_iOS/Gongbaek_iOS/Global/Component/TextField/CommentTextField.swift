...
struct CommentTextField: View {
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            CommentTextFieldContent(writeComment: $writeComment, textFieldHeight: $textFieldHeight, sendButtonTapped: $sendButtonTapped)
        }
        .padding(.vertical, 10)
...
struct CommentTextFieldContent: View {
    @Binding var writeComment: String
    @Binding var textFieldHeight: CGFloat
    @Binding var sendButtonTapped: (() -> Void)?
